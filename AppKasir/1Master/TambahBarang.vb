        ...
        Using cmd As New MySqlCommand(sql, conn)
            ...
            Using rd As MySqlDataReader = cmd.ExecuteReader()
                If rd.Read() Then
                    ...
                    _hargaBeli = ModuleAngka.ParseDecimal(rd("HARGA_BELI"))
                    _hargabeliterakhir = ModuleAngka.ParseDecimal(rd("HARGA_BELI_TERAKHIR"))
                    ...
                    _hargaJualUmumKecil = ModuleAngka.ParseDecimal(rd("HARGA_JUAL_UMUM_KECIL"))
                    _hargaJualUmumSedang = ModuleAngka.ParseDecimal(rd("HARGA_JUAL_UMUM_SEDANG"))
                    _hargaJualUmumBesar = ModuleAngka.ParseDecimal(rd("HARGA_JUAL_UMUM_BESAR"))
                    ...
                    _hargaJualPartaiKecil = ModuleAngka.ParseDecimal(rd("HARGA_JUAL_PARTAI_KECIL"))
                    _hargaJualPartaiSedang = ModuleAngka.ParseDecimal(rd("HARGA_JUAL_PARTAI_SEDANG"))
                    _hargaJualPartaiBesar = ModuleAngka.ParseDecimal(rd("HARGA_JUAL_PARTAI_BESAR"))
                    _stokTokoAwal = ModuleAngka.ParseDecimal(rd("STOK_TOKO"))
                    _stokGudangAwal = ModuleAngka.ParseDecimal(rd("STOK_GUDANG"))
                End If
            End Using
        End Using
