...
--
-- Host: localhost
-- Generation Time: Mar 03, 2026 at 09:26 PM
...
CREATE TABLE `bon_karyawan` (
  ...
  `ID_KOMPUTER` varchar(30) DEFAULT NULL
...
CREATE TABLE `hutang` (
  `NOBAYARHUTANG` varchar(30) DEFAULT NULL,
  `KODESUPLIYER` varchar(20) DEFAULT NULL,
  `NAMASUPLIYER` varchar(100) DEFAULT NULL,
  ...
  `ID_USER_BAYAR` varchar(20) DEFAULT NULL,
  `ID_KOMPUTER_BAYAR` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `hutang_detail` (
  ...
  `LOKASI` varchar(20) DEFAULT NULL,
  `ID_BELI` varchar(30) DEFAULT NULL,
...
CREATE TABLE `jurnalumum` (
  ...
  `AKUN_D` varchar(100) DEFAULT NULL,
  `NAMA_AKUN_D` varchar(50) DEFAULT NULL,
  `NOMOR_AKUN_D` varchar(20) DEFAULT NULL,
  `AKUN_K` varchar(100) DEFAULT NULL,
  `NAMA_AKUN_K` varchar(50) DEFAULT NULL,
  `NOMOR_AKUN_K` varchar(20) DEFAULT NULL,
  `NAMA_BANTU_D` varchar(50) DEFAULT NULL,
  `KODE_BANTU_D` varchar(20) DEFAULT NULL,
  `NAMA_BANTU_K` varchar(50) DEFAULT NULL,
  `KODE_BANTU_K` varchar(20) DEFAULT NULL,
...
CREATE TABLE `pembelian` (
  ...
  `NAMA_SUPLIYER` varchar(100) DEFAULT NULL,
...
CREATE TABLE `pembelian_detail` (
  `NO` int(11) NOT NULL,
  `FAKTUR_BELI` varchar(15) DEFAULT NULL,
  `NOTA_BELI` varchar(30) DEFAULT NULL,
...
CREATE TABLE `pembelian_ditahan` (
  ...
  `TOTAL_QTY` decimal(10,2) DEFAULT '0.00',
  `TOTAL_BARANG` decimal(10,2) DEFAULT '0.00',
  `PEMBAYARAN` decimal(15,0) DEFAULT NULL,
  `TGL_RETUR` datetime DEFAULT NULL,
  `RETUR` decimal(10,2) DEFAULT '0.00',
  `TAGIHAN` decimal(15,0) DEFAULT NULL,
  `JATUH_TEMPO` datetime DEFAULT NULL,
  `TGL_BAYAR` datetime DEFAULT NULL,
  `NOMINALBAYAR` decimal(15,0) DEFAULT '0',
  `STATUS_JUAL` varchar(20) DEFAULT NULL,
...
CREATE TABLE `penjualan` (
  ...
  `TGL_TRANSAKSI` datetime DEFAULT NULL,
  `TOTAL_HPP` decimal(15,0) DEFAULT '0',
  `GRAND_TOTAL_SBL_PAJAK` decimal(15,0) DEFAULT '0',
...
CREATE TABLE `piutang` (
  `ID_BAYAR_PIUTANG` varchar(20) DEFAULT NULL,
...
CREATE TABLE `piutang_detail` (
  ...
  `TANGGAL_BAYAR` datetime DEFAULT NULL,
  `LOKASI` varchar(20) DEFAULT NULL,
  `ID_JUAL` varchar(30) DEFAULT NULL,
  `KODE` varchar(20) DEFAULT NULL,
  `NAMA` varchar(100) DEFAULT NULL,
...
CREATE TABLE `retur_pembelian` (
  `ID_RETUR_PEMBELIAN` varchar(30) DEFAULT NULL,
  ...
  `TOTAL_QTY` decimal(10,2) DEFAULT '0.00',
  `TOTAL_RUPIAH` decimal(15,0) DEFAULT '0',
  `JENIS_PENGEMBALIAN` varchar(20) DEFAULT NULL,
  `NAMA_REKENING` varchar(60) DEFAULT NULL,
  `KODE_REKENING` varchar(20) DEFAULT NULL,
  `ALASAN_RETUR` varchar(255) DEFAULT NULL,
  `ID_USER` varchar(20) DEFAULT NULL,
  `ID_KOMPUTER` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `retur_pembelian_detail` (
  `ID_RETUR_PEMBELIAN` varchar(15) DEFAULT NULL,
  `TGL_RETUR_BELI` datetime DEFAULT NULL,
  `ID_SUPLIYER` varchar(10) DEFAULT NULL,
  `NAMA_SUPLIYER` varchar(100) DEFAULT NULL,
  `ID_BARANG` varchar(15) DEFAULT NULL,
...
CREATE TABLE `retur_penjualan` (
  `ID_RETUR_PENJUALAN` varchar(30) DEFAULT NULL,
  ...
  `KONTAK_PELANGGAN` varchar(20) DEFAULT NULL,
...
CREATE TABLE `retur_penjualan_detail` (
  `ID_RETUR_PENJUALAN` varchar(15) DEFAULT NULL,
  `TGL_RETUR_JUAL` datetime DEFAULT NULL,
  `LOKASI` varchar(20) DEFAULT NULL,
  `ID_PELANGGAN` varchar(30) DEFAULT NULL,
  `NAMA_PELANGGAN` varchar(100) DEFAULT NULL,
...
CREATE TABLE `stok_opname` (
  `ID_STOK_OPNAME` varchar(20) DEFAULT NULL,
  `TANGGAL` datetime DEFAULT NULL,
  `LOKASI` varchar(20) DEFAULT NULL,
  `ID_BARANG` varchar(30) DEFAULT NULL,
  `NAMA_BARANG` varchar(100) DEFAULT NULL,
...
CREATE TABLE `surat_jalan` (
  ...
  `KODE_SUPIR` varchar(20) DEFAULT NULL,
  `SUPIR` varchar(30) DEFAULT NULL,
  `KODE_HELPER1` varchar(20) DEFAULT NULL,
  `HELPER1` varchar(30) DEFAULT NULL,
  `KODE_HELPER2` varchar(20) DEFAULT NULL,
  `HELPER2` varchar(30) DEFAULT NULL,
  `ID_USER` varchar(50) DEFAULT NULL,
  `ID_KOMPUTER` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `surat_jalan_detail` (
  ...
  `LOKASISIMPAN` varchar(20) DEFAULT NULL,
  `NOTA_BELANJA` varchar(30) DEFAULT NULL,
  `KODE_PELANGGAN` varchar(20) DEFAULT NULL,
  `NAMA_PELANGGAN` varchar(50) DEFAULT NULL,
  `ALAMAT_PELANGGAN` varchar(200) DEFAULT NULL,
...
CREATE TABLE `tbl_barang` (
  ...
  `ID_BARANG_BANTU` varchar(50) DEFAULT NULL,
  `NAMA_BARANG` varchar(200) NOT NULL,
  `NAMA_BARANG_BANTU` varchar(100) DEFAULT NULL,
  `JENIS` varchar(20) DEFAULT NULL,
  `KODE_KATEGORI` varchar(30) DEFAULT NULL,
  `NAMA_KATEGORI` varchar(50) DEFAULT NULL,
  `KODE_SUPLIYER` varchar(50) DEFAULT NULL,
  `NAMA_SUPLIYER` varchar(100) DEFAULT NULL,
  ...
  `BARCODE_KECIL` varchar(20) DEFAULT NULL,
  `BARCODE_SEDANG` varchar(20) DEFAULT NULL,
  `BARCODE_BESAR` varchar(20) DEFAULT NULL,
  `SATUAN_UMUM_KECIL` varchar(20) DEFAULT NULL,
  `SATUAN_UMUM_SEDANG` varchar(20) DEFAULT NULL,
  `SATUAN_UMUM_BESAR` varchar(20) DEFAULT NULL,
  ...
  `SATUAN_PARTAI_KECIL` varchar(20) DEFAULT NULL,
  `SATUAN_PARTAI_SEDANG` varchar(20) DEFAULT NULL,
  `SATUAN_PARTAI_BESAR` varchar(20) DEFAULT NULL,
  ...
  `LOKASI_RAK_TOKO` varchar(50) DEFAULT NULL,
  `LOKASI_RAK_GUDANG` varchar(50) DEFAULT NULL,
...
CREATE TABLE `tbl_datareferensi` (
  ...
  `TYPE_AKUN` varchar(30) NOT NULL,
  `KODE_AKUN` varchar(20) NOT NULL,
  `NAMA_AKUN` varchar(100) NOT NULL,
  `SUB_AKUN` varchar(20) DEFAULT NULL,
  `AKUN_DK` varchar(20) DEFAULT NULL,
  `AKUN_NRLR` varchar(20) DEFAULT NULL,
  `SALDO_AWAL` decimal(20,0) DEFAULT '0',
...
CREATE TABLE `tbl_gaji` (
  ...
  `JENIS_POTONGAN` varchar(20) DEFAULT NULL,
...
CREATE TABLE `tbl_perusahaan` (
  ...
  `FOOTER1` varchar(50) DEFAULT NULL,
  `FOOTER2` varchar(50) DEFAULT NULL,
  `FOOTER3` varchar(100) NOT NULL,
  `NAMA_REK_BARANG` varchar(50) DEFAULT NULL,
  `KODE_REK_BARANG` varchar(20) DEFAULT NULL,
  `LAWAN_NAMA_REK_BARANG` varchar(50) DEFAULT NULL,
  `LAWAN_KODE_REK_BARANG` varchar(20) DEFAULT NULL,
  `NAMA_REK_BELI_TOKO` varchar(50) DEFAULT NULL,
  `KODE_REK_BELI_TOKO` varchar(20) DEFAULT NULL,
  `NAMA_REK_BELI_GUDANG` varchar(50) DEFAULT NULL,
  `KODE_REK_BELI_GUDANG` varchar(20) DEFAULT NULL,
  `NAMA_REK_JUAL_TOKO` varchar(50) DEFAULT NULL,
  `KODE_REK_JUAL_TOKO` varchar(20) DEFAULT NULL,
  `NAMA_REK_JUAL_GUDANG` varchar(50) DEFAULT NULL,
  `KODE_REK_JUAL_GUDANG` varchar(20) DEFAULT NULL,
  `NAMA_REK_HUTANG_BELI` varchar(50) DEFAULT NULL,
  `KODE_REK_HUTANG_BELI` varchar(20) DEFAULT NULL,
  `NAMA_REK_PIUTANG_JUAL` varchar(50) DEFAULT NULL,
  `KODE_REK_PIUTANG_JUAL` varchar(20) DEFAULT NULL,
  `NAMA_REK_A` varchar(50) DEFAULT NULL,
  `KODE_REK_A` varchar(20) DEFAULT NULL,
  `NAMA_REK_B` varchar(50) DEFAULT NULL,
  `KODE_REK_B` varchar(20) DEFAULT NULL,
  `NAMA_REK_C` varchar(50) DEFAULT NULL,
  `KODE_REK_C` varchar(20) DEFAULT NULL,
  `NAMA_REK_D` varchar(50) DEFAULT NULL,
  `KODE_REK_D` varchar(20) DEFAULT NULL,
  `NAMA_REK_E` varchar(50) DEFAULT NULL,
  `KODE_REK_E` varchar(20) DEFAULT NULL,
  `NAMA_REK_F` varchar(50) DEFAULT NULL,
  `KODE_REK_F` varchar(20) DEFAULT NULL,
  `SYSTEM_TUTUP_BULAN` varchar(50) DEFAULT NULL,
...
CREATE TABLE `tbl_user` (
  ...
  `login_session_key` varchar(100) DEFAULT NULL,
...
CREATE TABLE `tempbukubesarpembantu` (
  ...
  `NONOTA` varchar(20) DEFAULT NULL,
...
CREATE TABLE `temp_jurnal` (
  `TYPE_AKUN` varchar(30) DEFAULT NULL,
  `KODE_AKUN` varchar(10) DEFAULT NULL,
  `NAMA_AKUN` varchar(50) DEFAULT NULL,
  `SUB_AKUN` varchar(20) DEFAULT NULL,
  `AKUN_DK` varchar(20) DEFAULT NULL,
  `AKUN_NLRL` varchar(20) DEFAULT NULL,
  `SALDO_AWAL` decimal(20,0) DEFAULT '0',
  `DEBET` decimal(20,0) DEFAULT '0',
  `KREDIT` decimal(20,0) DEFAULT '0',
  `SALDO_AKHIR` decimal(20,0) DEFAULT '0'
...
CREATE TABLE `transfer_barang_detail` (
  `ID_TRANSFER` varchar(15) DEFAULT NULL,
  `TGL_TRANSFER` datetime DEFAULT NULL,
  `LOKASI` varchar(10) DEFAULT NULL,
  `ID_BARANG` varchar(30) DEFAULT NULL,
  `NAMA_BARANG` varchar(100) DEFAULT NULL,
...
CREATE TABLE `transfer_stok` (
  ...
  `JENIS_TRANSFER` varchar(50) DEFAULT NULL,
  `URAIAN` varchar(60) DEFAULT NULL,
  `TANGGAL` datetime DEFAULT NULL,
  `ID_BARANG_M` varchar(20) DEFAULT NULL,
  `NAMA_BARANG_M` varchar(100) DEFAULT NULL,
  `QTY_M` decimal(10,2) DEFAULT '0.00',
  `SATUAN_M` varchar(20) DEFAULT NULL,
  ...
  `ID_BARANG_K` varchar(20) DEFAULT NULL,
  `NAMA_BARANG_K` varchar(100) DEFAULT NULL,
  `QTY_K` decimal(10,2) DEFAULT '0.00',
  `SATUAN_K` varchar(20) DEFAULT NULL,
