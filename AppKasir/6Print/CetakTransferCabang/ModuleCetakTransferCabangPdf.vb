...
' ================================================================
' ModuleCetakTransferCabangPdf
' Export nota transfer antar cabang ke PDF via GdiCetakTransferCabang.
' Mengikuti pola ModuleCetakJualPdf yang sudah verified.
' ================================================================
Module ModuleCetakTransferCabangPdf
    ...
    Public Sub ExportPdf(Optional tampilF1 As Boolean = True,
        ...
        Dim sfd As New SaveFileDialog() With {
            .Title = "Simpan Transfer Cabang sebagai PDF",
            .Filter = "PDF Files (*.pdf)|*.pdf",
            .FileName = "TransferCabang_" & TC_IdTransfer.Replace("/", "-") & ".pdf",
            .DefaultExt = "pdf"}
        If sfd.ShowDialog() <> DialogResult.OK Then Exit Sub

        Try
            Dim cetak As New GdiCetakTransferCabang()
