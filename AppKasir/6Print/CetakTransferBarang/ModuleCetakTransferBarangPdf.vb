...
Module ModuleCetakTransferBarangPdf
    ...
    Public Sub ExportPdf(Optional tampilF1 As Boolean = True,
        ...
        Dim sfd As New SaveFileDialog() With {
            .Title = "Simpan Transfer Barang sebagai PDF",
            .Filter = "PDF Files (*.pdf)|*.pdf",
            .FileName = "TransferBarang_" & TB_IdTransfer.Replace("/", "-") & ".pdf",
            .DefaultExt = "pdf"}
        If sfd.ShowDialog() <> DialogResult.OK Then Exit Sub
        Try
            Dim cetak As New GdiCetakTransferBarang()
            ...
            If bitmaps.Count = 0 Then
                MessageBox.Show("Gagal merender nota.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
            End If
