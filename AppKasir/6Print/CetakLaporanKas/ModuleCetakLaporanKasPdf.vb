...
Module ModuleCetakLaporanKasPdf

    Public Sub ExportPdf(cetak As GdiCetakLaporanKas,
                          Optional f1 As Boolean = True,
                          Optional f2 As Boolean = True,
                          Optional f3 As Boolean = True)
        Dim sfd As New SaveFileDialog() With {
            .Title = "Simpan Laporan Kas sebagai PDF",
            .Filter = "PDF Files (*.pdf)|*.pdf",
            .FileName = "LaporanKas_" & cetak.LK_Rekening.Replace("/", "-") & "_" & Now.ToString("yyyyMMdd") & ".pdf",
            .DefaultExt = "pdf"}
        ...
        Try
            ...
            If bitmaps.Count = 0 Then
                MessageBox.Show("Gagal merender laporan.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
    ...
    ' Overload tanpa parameter cetak — buat instance baru dari data yang sudah ada
