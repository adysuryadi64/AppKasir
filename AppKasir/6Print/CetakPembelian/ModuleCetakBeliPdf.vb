...
' ================================================================
' ModuleCetakBeliPdf — Export nota pembelian ke PDF via iTextSharp
' ================================================================
Module ModuleCetakBeliPdf

    Public Sub ExportPdf(Optional f1 As Boolean = True,
                          Optional f2 As Boolean = True,
                          Optional f3 As Boolean = True)
        Dim sfd As New SaveFileDialog() With {
            .Title = "Simpan Nota Pembelian sebagai PDF",
            .Filter = "PDF Files (*.pdf)|*.pdf",
            .FileName = "Pembelian_" & Beli_IdPembelian.Replace("/", "-") & ".pdf",
            .DefaultExt = "pdf"}
        If sfd.ShowDialog() <> DialogResult.OK Then Exit Sub
        Try
            Dim cetak As New GdiCetakBeliThermalMatrik()
