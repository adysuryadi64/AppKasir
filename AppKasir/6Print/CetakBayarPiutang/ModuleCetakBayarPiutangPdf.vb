...
Module ModuleCetakBayarPiutangPdf

    Public Sub ExportPdf(Optional f1 As Boolean = True, Optional f2 As Boolean = True, Optional f3 As Boolean = True)
        Dim sfd As New SaveFileDialog() With {
            .Title = "Simpan Bukti Bayar Piutang sebagai PDF",
            .Filter = "PDF Files (*.pdf)|*.pdf",
            .FileName = "BayarPiutang_" & BP_NoBayar.Replace("/", "-") & ".pdf",
            .DefaultExt = "pdf"}
        If sfd.ShowDialog() <> DialogResult.OK Then Exit Sub
        Try
            Dim cetak As New GdiCetakBayarPiutang()
